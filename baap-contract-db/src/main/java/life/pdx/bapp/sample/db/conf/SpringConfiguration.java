package life.pdx.bapp.sample.db.conf;
...
@Configuration
@ComponentScan(basePackages = {"life.pdx.bapp.sample.db"})
@EnableJpaRepositories(basePackages = {"life.pdx.bapp.sample.db.repository"})
