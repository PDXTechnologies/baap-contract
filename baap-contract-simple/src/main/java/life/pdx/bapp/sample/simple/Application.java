...
package life.pdx.bapp.sample.simple;
...
import biz.pdxtech.baap.setting.context.BaapContextBinder;
import biz.pdxtech.baap.setting.reader.TransactionReader;
@ApplicationPath("rest")
public class Application extends ResourceConfig {
	public Application() {
		packages("life.pdx.bapp.sample.simple.contract")
